                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div v-if="$v.departmentName.$error">
                                                            <div class="alert alert-danger" role="alert" v-if="!$v.departmentName.required">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="departmentdesc" rows="5" v-model="description"></textarea>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-3">Department Image</h4>                                        
                                            <vue-dropzone ref="myVueDropzone" id="dropzone" :options="dropzoneOptions" :useCustomSlot="true" v-on:vdropzone-success="createdDepartment"></vue-dropzone>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form>        
                                            <span @click="saveDepartment()" type="submit" class="btn btn-primary mr-1 waves-effect waves-light">Save Department</span>        
                                        </form>
...
export default {
    ...
    methods:{
        ...
        createdDepartment(file, response)
        {
            this.department = response.id;
            
             Axios.post(process.env.MIX_APP_URL+'/save/department', {department_id: this.department, name: this.departmentName, department: this.department, description: this.description})
            .then(response => {
                if(response.data == true)
                {
                    this.$snotify.success('DEPARTMENT SAVED!', {
                        timeout: 2000,
