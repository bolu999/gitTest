        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                            ...
                            <form class="mt-4 mt-sm-0 float-sm-right form-inline">
                                <!-- <div class="search-box mr-2">
                                    <div class="position-relative">
                                        <input  v-model.lazy="result" type="text" class="form-control border-0" placeholder="Search...">
                                        <i class="bx bx-search-alt search-icon"></i>
                                    </div>
                                </div> -->
                                <ul class="nav nav-pills product-view-nav">
                                    <div class="text-sm-right">
                                        <router-link to="/admin-new-category" class="btn btn-success btn-rounded waves-effect waves-light"><i class="mdi mdi-plus mr-1"></i> New Category</router-link>
                                    </div>
                                </ul>                                 
                            </form>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-sm-6" v-for="(category, index) in categories" :key="index">
                            <div class="card">
                                <div class="card-body">
                                    <div class="product-img position-relative">
                                        <router-link :to="{path : '/admin-category-detail/'+category.id}">
                                            <img :src="category.image_path" alt="" style="height: 150px;" class="img-fluid mx-auto d-block">
                                        </router-link>
                                    </div>
                                    <div class="mt-4 text-center">
                                        <h2 class="mb-3 text-truncate"><router-link :to="{path : '/admin-category-detail/'+category.id}" class="text-dark">{{category.name}}</router-link></h2>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <span @click="deleteCategory(category.id)" type="button" class="btn btn-danger waves-effect  mt-2 waves-light">
   ...
   methods : {
    ...
    //   },
        ...
        search()
        {
            if(this.result != '')
            {
                Axios.post('/admin/search/category', {  keywords: this.result })
